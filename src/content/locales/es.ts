...
export const es: Dictionary = {
  ...
  home: {
    ...
    stats: [
      ...
      { value: "1", label: "Publicaciones y presentaciones" },
  ...
  extracurricular: {
    upcOrchestra: {
      title: "Orquesta de la UPC",
      role: "Saxofonista",
      bullets: ["Saxofonista en la orquesta universitaria."],
    },
  },
  publications: [
    {
  ...
  projects: {
    ...
    "rocket-avionics": {
      ...
      teamPhotoAlt: "Foto de grupo del equipo del Sunspear",
      teamCaption: "El equipo del Sunspear.",
      outcome:
    ...
    "plasma-magnetospheres": {
      ...
      outcomeFigures: [
        {
          alt: "Dos personas junto al póster en MOP 2026",
          caption: "Con Fiona Martin en MOP 2026, Toulouse.",
        },
        {
          alt: "Póster: Plasma leakage through the magnetospheric boundaries of Jupiter and Saturn, presentado en MOP 2026",
          caption: "Póster presentado en MOP 2026, Toulouse.",
        },
      ],
